...
export class Id extends ValueObject<IdProps> {
  ...
  public static create(value: string) {
    ...
    if (typeof value !== 'string') throw new ValidationDomainError('Id: value must be a string');

    if (value.trim() === '') throw new ValidationDomainError('Id: value cannot be empty');
